...
3. **Обновлённый CHANGELOG фазы** с явной оценкой стоимости и латентности на канареечном репо (сам LV_DCP).
4. **Dogfood report**: лог запуска инструмента на самом LV_DCP с качественной оценкой.
5. **Обновлённая конституция или ADR**, если по ходу фазы были приняты решения, влияющие на правила.
