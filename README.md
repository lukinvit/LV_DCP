...
**Local-first engineering memory.** Turns projects on macOS into a queryable context layer for Claude, IDE agents, and humans. Supports Python, TypeScript/JS, Go, Rust, and Java. Reduces token cost of repeated code reading, builds a relation graph, and makes agent edits safer.

[![Phase 9 Complete](https://img.shields.io/badge/phase-9%20complete-green)](docs/release/2026-04-24-v0.8.20-java-parser.md)
[![Version 0.8.20](https://img.shields.io/badge/version-0.8.20-blue)](pyproject.toml)
...
- **Phase 10** (next) — Kotlin / Swift parsers, VS Code marketplace, Obsidian nightly sync.
